...
* `console.log` vs. `console.dir`
   * `console.dir` lets you see all the properties of a specified JS object
* `htmlFor` allows you to pass the id of an input value to associate the label with that input value. When the user clicks on the label, the input value will then automatically go into focus
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=manasa.tipparam%40gmail.com).
